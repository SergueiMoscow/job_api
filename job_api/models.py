...
def check_functions():
    ...
    Имена функций корфигуртся в списке funcions данной функции.
    Тело функции должно быть в одноимённом файле с именем функции с расширением .sql в папке db проекта.
    """
    functions = [
        'get_statuses',
        'get_statuses_arr',
